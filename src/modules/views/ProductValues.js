  ...
  return (
    <div>
      <div id="call">
        ...
        <a class="phone-link" href="tel:510-875-9962">
          510-875-9962
        </a>
      </div>
          ...
          <Grid container spacing={5}>
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                <Typography
                  variant="h5"
                  sx={{ my: 3, fontWeight: 600, color: "#FFCC00" }}
                >
                  Express Detail
                </Typography>
            ...
            <Grid item xs={12} md={4}>
              <Box sx={item}>
                ...
                <Typography variant="body1" sx={{ mb: 3, color: "white" }}>
                  Our premium Royalty Detail package includes all the features
                  of our Luxury Detail package and more:
                </Typography>
                <ul>
